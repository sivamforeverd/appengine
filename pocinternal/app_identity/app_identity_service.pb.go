...
func init() {
	proto.RegisterFile("github.com/sivamforeverd/appengine/pocinternal/app_identity/app_identity_service.proto", fileDescriptor_app_identity_service_08a6e3f74b04cfa4)
}
